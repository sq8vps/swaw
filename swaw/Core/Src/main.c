...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LED_Pin|ADS_START_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USB_PU_GPIO_Port, USB_PU_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI1_CS_Pin|ADS_RESET_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LED_Pin ADS_START_Pin ADS_RESET_Pin */
  GPIO_InitStruct.Pin = LED_Pin|ADS_START_Pin|ADS_RESET_Pin;
  ...
  /*Configure GPIO pin : ADS_READY_Pin */
